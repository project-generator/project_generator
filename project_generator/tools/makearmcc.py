...
class MakefileArmcc(Tool, Exporter):
    ...
    def _parse_specific_options(self, data):
        ...
        data['cxx_flags'] = []
        data['asm_flags'] = []
        data['pre_build_script'] = []
        data['post_build_script'] = []
    ...
    def export_workspace(self):
        logger.debug("Makefile ARMCC currently does not support workspaces")
    ...
    def build_project(self):
        ...
        logger.debug("Building ARMCC project: %s" % path)
