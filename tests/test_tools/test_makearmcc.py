...
class TestProject(TestCase):
    ...
    def setUp(self):
        ...
        self.makearmcc = MakefileArmcc(self.project.project, ProjectSettings())
    ...
    def test_export_project(self):
        result = self.project.generate('make_armcc', False)
        projectfiles = self.project.get_generated_project_files('make_armcc')
